...
def run_filar4_rq2():
    print("=== Filar 4 (Wyjaśnienia Globalne SAGE) - RQ2: Concept Drift ===")
    ...
    for size in tqdm(bg_sizes, desc="RQ2 (Filar 4) sizes"):
        ...
        estimator_past = sage.PermutationEstimator(imputer_past, 'cross_entropy')
        ...
        estimator_future = sage.PermutationEstimator(imputer_future, 'cross_entropy')
